...
const FR = ['ID','模块','功能','描述','优先级','状态','实现文件','备注'];
const req = [
  ['REQ-01','剪贴板监控','剪贴板轮询','300ms定时轮询系统剪贴板','P0','✅ 已完成','clipboard-monitor.ts','SHA256哈希去重'],
  ['REQ-02','剪贴板监控','前景应用检测','异步PowerShell获取前台窗口标题','P0','✅ 已完成','clipboard-monitor.ts','2s缓存'],
  ['REQ-03','数据库','SQLite存储','WAL模式自动建表迁移','P0','✅ 已完成','database.ts','3表'],
  ['REQ-04','数据库','CRUD操作','插入/查询/更新/删除','P0','✅ 已完成','database.ts',''],
  ['REQ-05','数据库','智能清理','自动清理非收藏非置顶记录','P0','✅ 已完成','database.ts','每小时一次'],
  ['REQ-06','收藏/置顶','toggle切换','状态切换DB持久化','P0','✅ 已完成','database.ts','CASE WHEN'],
  ['REQ-07','QuickPick','浮窗唤起','Ctrl+Shift+V全局快捷键','P0','✅ 已完成','index.ts','可自定义快捷键'],
  ['REQ-08','QuickPick','列表渲染','原生div+CSS line-clamp','P0','✅ 已完成','QuickPick.tsx v2.4','弃用AD List'],
  ['REQ-09','QuickPick','搜索过滤','实时搜索过滤剪贴板记录','P0','✅ 已完成','QuickPick.tsx',''],
  ['REQ-10','QuickPick','键盘导航','上下选择/Enter粘贴/Esc关闭','P0','✅ 已完成','QuickPick.tsx',''],
  ['REQ-11','QuickPick','收藏/置顶操作','点击星标图钉','P0','✅ 已完成','QuickPick.tsx','B9 v2.3 loadItems修复'],
  ['REQ-12','QuickPick','窗口拖拽','14px拖拽手柄','P0','✅ 已完成','global.css','B11已修复'],
  ['REQ-13','主窗口','2Tab布局','剪切板+收藏Tab','P0','✅ 已完成','MainWindow.tsx v1.6','CSS类化完成'],
  ['REQ-14','主窗口','详情面板','选中条目显示完整内容','P0','✅ 已完成','MainWindow.tsx',''],
  ['REQ-15','主窗口','搜索清空','搜索过滤+清空操作','P0','✅ 已完成','MainWindow.tsx',''],
  ['REQ-16','设置面板','外观设置','主题/强调色/字号/语言','P0','✅ 已完成','Settings.tsx v1.3',''],
  ['REQ-17','设置面板','数据设置','保留天数/最大记录/开机自启','P0','✅ 已完成','Settings.tsx',''],
  ['REQ-18','设置面板','快捷键自定义','录制按键动态更新','P2','✅ 已完成','Settings.tsx','P9已完成'],
  ['REQ-19','系统托盘','托盘图标+菜单','系统托盘','P0','✅ 已完成','index.ts','审计C1:图标不可见'],
  ['REQ-20','开机自启','Windows注册表','可配置开机自启','P0','✅ 已完成','auto-launch.ts',''],
  ['REQ-21','跨窗口同步','IPC广播','clipboard:itemUpdated','P0','✅ 已完成','ipc-handlers.ts',''],
  ['REQ-22','国际化','i18n中英切换','全部组件覆盖','P1','✅ 已完成','i18n.ts+locales/','审计C2/C3:托盘未i18n'],
  ['REQ-23','暗色主题','亮/暗双主题','data-theme+Ant Design','P1','✅ 已完成','global.css+App.tsx',''],
  ['REQ-24','应用图标','多尺寸ICO','generate-icon.cjs','P1','✅ 已完成','resources/icon.ico',''],
  ['REQ-25','打包','NSIS安装包','electron-builder','P1','✅ 已完成','package.json','npm run build:win'],
  ['REQ-26','测试','单元测试','133 tests 4 files','P1','✅ 已完成','tests/unit/',''],
  ['REQ-27','测试','E2E集成测试','24 tests','P2','✅ 已完成','tests/e2e/',''],
  ['REQ-28','CI/CD','本地预检','pre-push hook','P2','✅ 已完成','.git/hooks/pre-push','GitHub Actions已暂停'],
];
