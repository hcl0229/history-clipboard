...
> 版本：v7 | 日期：2026-06-11 | 状态：QuickPick 重构完成 ✅ B1-B11 全部解决
...
| B9 | Bug | 快速入口收藏/置顶后不刷新 | 06-11 | P0 | ✅ | **重构：弃用 AD List/Paragraph，原生 div + CSS line-clamp** |
...
| B9 | QuickPick 收藏/置顶不刷新 | **重构：原生 div + CSS line-clamp** |
| B10 | 快速入口/主界面不同步 | `clipboard:itemUpdated` IPC 广播 |
| B11 | QuickPick 无法拖拽 | `-webkit-app-region: drag` |
